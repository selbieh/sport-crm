...
class Task(TimeStampedModel):
    ...
    assigned_to = models.ForeignKey(User, on_delete=models.PROTECT, related_name="assigned_tasks", null=True, blank=True)
    deadline = models.DateField(null=False)
    reminder_intervals = models.CharField(max_length=150, null=True, blank=True)
    status = models.CharField(max_length=50, null=False, choices=STATUS_CHOICES, default=NEW)
